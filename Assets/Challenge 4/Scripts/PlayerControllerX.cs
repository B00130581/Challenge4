...
public class PlayerControllerX : MonoBehaviour
{
    ...
    private void Moveforward()
    {
        ...
        playerRb.AddForce(focalPoint.transform.forward * verticleInput * speed * Time.deltaTime);


        if(Input.GetKeyDown(KeyCode.Space) && turboAvailable)
        {
            playerRb.AddForce(focalPoint.transform.forward * speed * verticleInput * turboSpeedMultiplier, ForceMode.Impulse);
            TurboCooldown();
            smoke.Play();
        }
        ...
        {
            playerRb.AddForce(focalPoint.transform.forward * speed * verticleInput);
        }
    }
